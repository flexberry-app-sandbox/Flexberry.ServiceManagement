...
moduleForAcceptance('[AGAT] Acceptance | i i s service management service provider l');

test('testing i-i-s-service-management-service-provider-l', function(assert) {
