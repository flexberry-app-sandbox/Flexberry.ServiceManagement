...
moduleForModel('i-i-s-service-management-customer-request', 'Unit | Serializer | i-i-s-service-management-customer-request', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-service-management-customer-request',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
