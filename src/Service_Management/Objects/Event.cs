...
namespace IIS.Service_Management
{
    ...
    public class Event : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Service_Management.tEventType fEventType;
        ...
        private IIS.Service_Management.ServiceProvider fServiceProvider;
        ...
        public virtual IIS.Service_Management.tEventType EventType
        {
            get
            {
                ...
                IIS.Service_Management.tEventType result = this.fEventType;
        ...
        [NotNull()]
        public virtual IIS.Service_Management.ServiceProvider ServiceProvider
        {
            get
            {
                ...
                IIS.Service_Management.ServiceProvider result = this.fServiceProvider;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View EventE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EventE", typeof(IIS.Service_Management.Event));
                }
            }
            ...
            public static ICSSoft.STORMNET.View EventL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("EventL", typeof(IIS.Service_Management.Event));
                }
            }
        }
    }
