...
namespace IIS.Service_Management
{
    ...
    public class Ticket : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Service_Management.Customer fCustomer;
        
        private IIS.Service_Management.DetailArrayOfTicketPosition fTicketPosition;
        ...
        [NotNull()]
        public virtual IIS.Service_Management.Customer Customer
        {
            get
            {
                ...
                IIS.Service_Management.Customer result = this.fCustomer;
        ...
        public virtual IIS.Service_Management.DetailArrayOfTicketPosition TicketPosition
        {
            get
            {
                ...
                {
                    this.fTicketPosition = new IIS.Service_Management.DetailArrayOfTicketPosition(this);
                }
                IIS.Service_Management.DetailArrayOfTicketPosition result = this.fTicketPosition;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View TicketE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketE", typeof(IIS.Service_Management.Ticket));
                }
            }
            ...
            public static ICSSoft.STORMNET.View TicketL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketL", typeof(IIS.Service_Management.Ticket));
                }
            }
        }
    }
