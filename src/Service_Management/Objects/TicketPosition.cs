...
namespace IIS.Service_Management
{
    ...
    public class TicketPosition : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Service_Management.Event fEvent;
        
        private IIS.Service_Management.Ticket fTicket;
        ...
        [NotNull()]
        public virtual IIS.Service_Management.Event Event
        {
            get
            {
                ...
                IIS.Service_Management.Event result = this.fEvent;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Service_Management.Ticket.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.Service_Management.Ticket Ticket
        {
            get
            {
                ...
                IIS.Service_Management.Ticket result = this.fTicket;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View TicketPositionE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TicketPositionE", typeof(IIS.Service_Management.TicketPosition));
                }
            }
        }
    }
    ...
    public class DetailArrayOfTicketPosition : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Service_Management.DetailArrayOfTicketPosition members)

        // *** End programmer edit section *** (IIS.Service_Management.DetailArrayOfTicketPosition members)
        ...
        /// </summary>
        public DetailArrayOfTicketPosition(IIS.Service_Management.Ticket fTicket) : 
                base(typeof(TicketPosition), ((ICSSoft.STORMNET.DataObject)(fTicket)))
        {
        }
        
        public IIS.Service_Management.TicketPosition this[int index]
        {
            get
            {
                return ((IIS.Service_Management.TicketPosition)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Service_Management.TicketPosition dataobject)
        {
